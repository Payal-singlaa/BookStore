...
{/* Left Section (Text) */}
  <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-0">
    <div className="space-y-12">
      ...
      <p className="text-xl">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, quaerat odio nisi, amet quam omnis cumque libero eveniet non facere, nobis sit accusamus ipsa similique? Natus laborum laudantium sint unde!
      </p>
